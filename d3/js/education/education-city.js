 ...
 */
 ...
 EducationalCityAttainmentChart.prototype.init = function(rawData){
    ...
    $('#educationCity2010').empty();
    $('#educationCity2020').empty();
    ...
    // $('#collegeOrHigher2019').empty();
        ...
        var education2010Div = d3.select("#educationCity2010")
        ...
        var lessThanHighSchool2020Div = d3.select("#educationCity2020")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
