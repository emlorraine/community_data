 ...
 function EducationalCityAttainmentChart(data){
    console.log(data)
    var self = this;
    self.init(data);
};
 ...
 */
 ...
 EducationalCityAttainmentChart.prototype.init = function(rawData){
    ...
    $('#lessThanHighSchoolCity2010').empty();
    $('#highSchoolOrEquivalentCity2010').empty();
    $('#collegeOrHigherCity2010').empty();

    $('#lessThanHighSchoolCity2019').empty();
    $('#highSchoolOrEquivalentCity2019').empty();
    $('#collegeOrHigherCity2019').empty();

        //Less than high school, 2010 
        var lessThanHighSchool2010Div = d3.select("#lessThanHighSchoolCity2010")
        ...
        var highSchoolOrEquivalent2010Div = d3.select("#highSchoolOrEquivalentCity2010")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
        ...
        var collegeOrHigher2010 = d3.select("#collegeOrHigherCity2010")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
        ...
        var lessThanHighSchool2019Div = d3.select("#lessThanHighSchoolCity2019")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
        ...
        var highSchoolOrEquivalent2019Div = d3.select("#highSchoolOrEquivalentCity2019")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
        ...
        var collegeOrHigher2019 = d3.select("#collegeOrHigherCity2019")
        self.margin = {top: 30, right: 20, bottom: 30, left: 50};
