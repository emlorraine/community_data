 ...
 */
  ...
  AgeStateChart.prototype.init = function(rawData){
     ...
     $('#age-state-2010').empty();
     $('#age-state-2020').empty();
 
     var ageDiv = d3.select("#age-state-2010")
     ...
     var ageDiv = d3.select("#age-state-2020")
             self.margin = {top: 30, right: 20, bottom: 30, left: 50};
             self.svg = ageDiv.append("svg")
                 .attr("width",900)
                 .attr("height",1100)
