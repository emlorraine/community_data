 ...
 RaceStateBarChart.prototype.init = function(rawData){
    ...
    var data = [
        { 
          "key": "White alone",
          "values":[
            {"key": "2010", "value": +(data2010[17].value.replaceAll(",", ""))},
            {"key": "2019", "value": +(data2020[17].value.replaceAll(",", ""))}
          ]
        },
        { 
          "key": "Black or African American alone",
          "values":[
            {"key": "2010", "value":+(data2010[18].value.replaceAll(",", ""))},
            {"key": "2019", "value":  +(data2020[18].value.replaceAll(",", ""))}
          ]
        },
        { 
          "key": "Asian alone",
          "values":[
            {"key": "2010", "value":  +(data2010[20].value.replaceAll(",", ""))},
            {"key": "2019", "value":  +(data2020[20].value.replaceAll(",", ""))}
          ]
        },
        { 
          "key": "Two or more races",
          "values":[
            {"key": "2010", "value":  +(data2010[23].value.replaceAll(",", ""))},
            {"key": "2019", "value":  +(data2020[23].value.replaceAll(",", ""))}
          ]
        },
        { 
