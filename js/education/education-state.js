 ...
 function EducationalStateAttainmentChart(data){
    var self = this;
    self.init(data);
};
/**
 ...
 */
 ...
 EducationalStateAttainmentChart.prototype.init = function(rawData){
    ...
    console.log("MO Masters", socialExplorer2020Data[31])
    var labels = [
    ...
    console.log(data2010, fullGrid2010)
    console.log(data2020, fullGrid2020)
